...
final createWorkspaceUsecaseProvider = Provider<CreateWorkspaceUsecase>(
  (ref) => CreateWorkspaceUsecase(ref.read(workspaceRepositoryProvider)),
);

class CreateWorkspaceUsecase implements UseCaseWithParams<dynamic, String> {
  ...
  Future<Either<Failure, dynamic>> call(String params) {
    return _repository.createWorkspace(params);
  }
}
